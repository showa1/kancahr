    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                ...
                <h1 class="text-2xl font-bold text-gray-800">Penilaian Kinerja</h1>
                <p class="text-sm text-gray-500 mt-1">Evaluasi dan penilaian performa karyawan secara berkala.</p>
            </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Periode Aktif</p>
                <p class="text-3xl font-bold text-gray-800">0</p>
            </div>
            <div class="rounded-2xl p-5 border shadow-sm bg-amber-50 border-amber-100 text-amber-600">
                <p class="text-xs font-semibold uppercase tracking-wider mb-2 opacity-80">Sudah Dinilai</p>
                <p class="text-3xl font-bold">0</p>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Belum Dinilai</p>
                <p class="text-3xl font-bold text-gray-800">0</p>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Rata-rata Skor</p>
                <p class="text-3xl font-bold text-gray-800">0</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                <h3 class="font-bold text-gray-800">Penilaian Kinerja</h3>
                <div class="relative">
            ...
            <div class="py-20 text-center">
                ...
                <p class="font-semibold text-gray-600">Belum ada data Penilaian Kinerja</p>
